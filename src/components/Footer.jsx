export default function Footer() {
  return (
    <footer class="flex flex-col items-center text-center text-surface shadow-md backdrop-blur-lg xl:bg-transparent bg-transparent  dark:text-black relative bottom-0">
      <div class="container px-6 pt-6 backdrop-blur-lg xl:bg-transparent bg-transparent">
